...
namespace UnitTests
{
    public class SpecialityTests
    {
        ...
        private readonly Speciality _entity = new Speciality()
        {
            Id = ExistingId
        };

        private readonly Speciality _nonExistingEntity = new Speciality()
        {
            Id = NonExistingId
        };

        private readonly IEnumerable<Speciality> _entities = new List<Speciality>()
        {
            new Speciality()
            {
                Id = ExistingId
        ...
        private Mock<ISqlRepository<Speciality>> _iSqlRepository;

        private SpecialityService _service;

        [SetUp]
        public void Setup()
        {
            _iSqlRepository = new Mock<ISqlRepository<Speciality>>();

            _service = new SpecialityService(_iSqlRepository.Object);
        }
