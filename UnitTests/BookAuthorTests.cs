...
namespace UnitTests
{
    public class BookAuthorTests
    {
        ...
        private readonly BookAuthor _entity = new BookAuthor()
        {
            Id = ExistingId
        };

        private readonly BookAuthor _nonExistingEntity = new BookAuthor()
        {
            Id = NonExistingId
        };

        private readonly IEnumerable<BookAuthor> _entities = new List<BookAuthor>()
        {
            new BookAuthor()
            {
                Id = ExistingId
        ...
        private Mock<ISqlRepository<BookAuthor>> _iSqlRepository;

        private BookAuthorService _service;

        [SetUp]
        public void Setup()
        {
            _iSqlRepository = new Mock<ISqlRepository<BookAuthor>>();

            _service = new BookAuthorService(_iSqlRepository.Object);
        }
